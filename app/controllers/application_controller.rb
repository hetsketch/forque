class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:account_update) { |user| user.permit(:username, :first_name, :last_name, :position, :bio, :city, :avatar, :current_password, :password, :password_confirmation) }
  end
end