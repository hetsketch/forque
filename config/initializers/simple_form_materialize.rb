...
SimpleForm.setup do |config|
  ...
  config.wrappers :materialize_toggle, tag: 'p', class: 'switch', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :materialize_radio_and_checkboxes, tag: 'div', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
    b.use :input
  ...
  config.wrappers :materialize_multiple_file_input, tag: 'div', class: 'file-field input-field', error_class: 'has-error' do |b|
    b.use :html5
